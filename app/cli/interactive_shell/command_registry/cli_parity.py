...
def _cmd_personal(session: ReplSession, console: Console, args: list[str]) -> bool:  # noqa: ARG001
    return run_cli_command(console, ["personal", *args])
...
COMMANDS: list[SlashCommand] = [
    ...
    SlashCommand(
        "/personal",
        "Plan and check personal messaging assistant setup.",
        _cmd_personal,
        usage=("/personal doctor", "/personal plan"),
        execution_tier=ExecutionTier.SAFE,
    ),
    SlashCommand(
        "/hermes",
