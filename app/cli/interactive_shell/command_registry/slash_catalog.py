...
_MCP_BY_COMMAND: dict[str, _SlashMcpFields] = {
    ...
    "/personal": _mcp(
        "Plan and check local personal messaging assistant setup for WhatsApp, iMessage, "
        "and low-cost LLM provider configuration.",
        "User asks to check personal assistant setup readiness",
        "User asks for a plan to configure WhatsApp, iMessage, Gemini, OpenAI, or Claude",
    ),
    "/privacy": _mcp(
