---
title: "OpsGenie"
description: "Connect OpsGenie so OpenSore can read active alerts and incident context during investigations"
---

OpenSore queries OpsGenie to retrieve active alerts and their details — correlating on-call incidents with infrastructure events and investigation findings.
...
3. Name it `opensore` and enable **Read** access
4. Copy the key
...
```bash
opensore integrations verify opsgenie
```
