...
description: "Set up OpenSore for your organization in app.tracer.cloud"
---

This guide is for teams that manage OpenSore from the hosted web app.
...
After integrations are connected, OpenSore investigations can use the same organization-level connectors and
policies.
