...
OpenSore's Twilio integration delivers investigation findings via **SMS**
...
(`opensore integrations setup whatsapp`) — see the [WhatsApp](/messaging/whatsapp)
...
```bash
opensore integrations setup twilio
```
...
```bash
opensore integrations verify twilio
```
...
### `opensore integrations verify twilio` errors
