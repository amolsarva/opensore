---
title: "Honeycomb"
description: "Connect Honeycomb so OpenSore can query traces during investigations"
---

OpenSore queries Honeycomb to surface distributed traces during alert investigations — identifying slow spans, high-error services, and query patterns correlated with incidents.
...
```bash
opensore integrations verify honeycomb
```
