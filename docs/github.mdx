---
title: "GitHub"
description: "Connect GitHub so OpenSore can correlate recent commits and code changes with incidents"
---

OpenSore connects to GitHub via the GitHub MCP server to search code, browse recent commits, inspect files, and trace changes correlated with alerts — helping identify which deployment or code change triggered an incident.
...
```bash
opensore integrations verify github
```
...
- Limit token scope to the repositories OpenSore needs to inspect.
