---
title: "Google Docs"
description: "Connect Google Docs so OpenSore can write investigation reports to your Google Drive"
---

OpenSore can write investigation findings directly to Google Drive as formatted Google Docs — creating a persistent, shareable record of each incident investigation linked to your team's existing Drive folder.
...
3. Give it a name (e.g., `opensore-docs`) and click **Create**
...
2. Click **Share**
3. Add the service account email (e.g., `opensore-docs@your-project.iam.gserviceaccount.com`)
...
```bash
opensore integrations verify google_docs
```
