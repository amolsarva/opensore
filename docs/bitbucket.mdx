---
title: "Bitbucket"
description: "Connect Bitbucket so OpenSore can correlate recent commits and code changes with incidents"
---

OpenSore queries Bitbucket to retrieve recent commits, file contents, and code search results — helping trace which change in a Bitbucket-hosted repository triggered an incident.
...
When OpenSore investigates a Bitbucket-related alert, three tools are available:
...
```bash
opensore integrations verify bitbucket
```
