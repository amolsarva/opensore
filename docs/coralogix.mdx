---
title: "Coralogix"
description: "Connect Coralogix so OpenSore can query logs during investigations"
---

OpenSore queries Coralogix using DataPrime to surface relevant logs during alert investigations — correlating log patterns with incidents and identifying root causes.
...
```bash
opensore integrations verify coralogix
```
